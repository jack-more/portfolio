...
const CARD_DATA = [
  ...
  { type: 'personal', title: 'Cribs.Fun', client: 'Co-Founder', img: '/images/cribs-fun-logo.png', desc: 'Mobile-first real estate price guessing game. React Native with freemium model.', metrics: false, period: 'Jan 2024 – Present', link: 'https://cribs.fun', linkLabel: 'cribs.fun', content: [] },
  ...
  { type: 'startup', title: 'Devolved AI', client: 'Marketing Manager', img: '/images/DevolvedAI.png', desc: 'Led marketing strategy that scaled AI platform to $100M valuation. Developed comprehensive product positioning and launch strategy.', metrics: true, period: 'Sep 2024 – Jun 2025', link: 'https://www.globenewswire.com/news-release/2024/12/05/2992635/0/en/Devolved-AI-Announces-Strategic-Partnership-with-GDA-Capital-to-Revolutionize-Blockchain-Powered-AI-Solutions.html', linkLabel: 'GDA Capital Partnership — GlobeNewsWire', content: [] },
      ...
      <div className="vortex-ui">
        <div className="vortex-bio">
          ...
          <div className="vortex-bio-text">
            ...
            <p>Led marketing at <span className="co co-g">Dtravel</span>, <span className="co co-r">NEAR Tasks</span>, and <span className="co co-y">Devolved AI</span>. <span className="hl-red">Scaled two past $100M.</span> <span className="hl-green">Grew the NEAR Protocol</span> with lightweight marketing applications.</p>
