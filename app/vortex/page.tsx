...
const CARD_DATA = [
  ...
  { type: 'personal', title: 'Morello Sims', client: 'Creator & Developer', img: '/images/morello-sims-logo.svg', desc: 'Full-stack sports simulation platform with 3D visualizations, ML clustering, and real-time data pipelines.', metrics: false, period: 'Jan 2024 – Present', link: 'https://morellosims.com', linkLabel: 'morellosims.com', content: [] },
  // ── STARTUP WORK (middle of helix) ──
  { type: 'startup', title: 'Travala', client: 'Dtravel Partnership', img: '/images/travala.png', desc: 'Supported marketing for Travala as part of the Dtravel ecosystem. Binance-backed crypto travel platform.', metrics: true, period: 'Apr 2021 – Apr 2022', link: 'https://www.travala.com/', linkLabel: 'Travala.com', content: [] },
  ...
  { type: 'startup', title: 'NEAR Tasks', client: 'Head of Marketing', img: '/images/near-protocol.png', desc: 'Managed full marketing strategy for AI-powered task marketplace. Grew user base from launch to 12,000 users in 18 months.', metrics: true, period: 'Apr 2022 – Jun 2024', link: 'https://pages.near.org/blog/near-tasks-launches-ai-marketplace-on-near-to-revolutionize-the-future-of-work/', linkLabel: 'NEAR Tasks Launch — NEAR Blog', content: [] },
  { type: 'startup', title: 'Incubella', client: 'Partner / Embedded Growth Lead', img: '/images/incubella-logo.svg', desc: 'Growth advisory firm building GTM systems for early-stage clients, including Devolved AI and Riskiiit engagements.', metrics: true, period: 'Jun 2024 - Present', link: 'https://www.incubella.co/', linkLabel: 'Incubella', content: [] },
  // ── AGENCY WORK (top of helix) ──
  { type: 'creative', title: 'Hint Water', client: 'Laundry Service', img: '/images/hint-water-logo.png', desc: 'Led copywriting and content planning for the premium flavored water brand.', metrics: false, period: 'May 2017 – Dec 2017', link: 'https://247laundryservice.com/', linkLabel: 'Laundry Service', content: [] },
  ...
  { type: 'media', title: 'Prime Video', client: 'EPK.TV', img: '/images/amazon-prime-video.png', desc: 'Managed content distribution for all Amazon originals — press kits, trailers, stills, and promotional assets.', metrics: true, period: 'Aug 2018 – Jan 2020', link: 'https://www.epk.tv/', linkLabel: 'EPK.TV Platform', content: [
    ...
    { name: 'The Report', url: 'https://www.youtube.com/watch?v=dZHWyAlRxvM' },
  ] },
  { type: 'media', title: 'Universal', client: 'EPK.TV', img: '/images/universal-logo.png', desc: 'Handled all theatrical press kit distribution — trailers, stills, featurettes, and promotional assets for every release.', metrics: true, period: 'Aug 2018 – Jan 2020', link: 'https://universal.epk.tv/', linkLabel: 'Universal — EPK.TV Portal', content: [
    ...
    { name: "A Dog's Journey", url: 'https://www.youtube.com/watch?v=VoaNlSEZCKE' },
  ] },
  ...
  { type: 'media', title: 'Disney+', client: 'EPK.TV', img: '/images/disneyplus.png', desc: 'Managed content distribution during the Disney+ platform launch — press kits, trailers, stills, and promotional assets.', metrics: true, period: 'Aug 2018 – Jan 2020', link: 'https://www.epk.tv/', linkLabel: 'EPK.TV Platform', content: [
    ...
    { name: 'The World According to Jeff Goldblum', url: 'https://www.youtube.com/watch?v=sP1Ov3Cnqpo' },
    { name: 'Noelle', url: 'https://www.youtube.com/watch?v=ZtJSLoGbiHg' },
    { name: 'Encore!', url: 'https://www.youtube.com/watch?v=-Y7TlaXDPrg' },
  ...
  return (
    <>
      <style>{`
        ...
        .vortex-content-list { margin-top: 1.5rem; padding-top: 1rem; border-top: 1px solid rgba(31,31,27,0.2); }
        .vortex-content-label { font-family: 'Space Mono', monospace; font-size: 0.6rem; font-weight: 700; text-transform: uppercase; letter-spacing: 0.15em; margin-bottom: 0.75rem; background: linear-gradient(transparent 55%, #FFFB26 55%); display: inline-block; }
      ...
      <div className="vortex-ui">
        <div className="vortex-bio">
          ...
          <div className="vortex-bio-text">
            ...
            <p>Led marketing at <span className="co co-g">Dtravel</span> and <span className="co co-r">NEAR Tasks</span>, plus <span className="co co-y">Incubella</span> client engagements including Devolved AI and Riskiiit. <span className="hl-red">Scaled startup work past $100M.</span> <span className="hl-green">Grew the NEAR Protocol</span> with lightweight marketing applications.</p>
            <div className="vortex-section-label">Personal</div>
            <p>Currently building <span className="co co-r">Morello Sims</span>, a sports simulation platform with NBA and MLB pick engines. <span className="hl-tan">Former college baseball pitcher.</span> <span className="co co-y">Lakers</span>, <span className="co co-g">Dodgers</span>, <span className="co co-r">Eagles</span>.</p>
